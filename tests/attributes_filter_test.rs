...
async fn test_user_attributes_parameter() {
    ...
    let response = server
        .get(&format!("/tenant-a/scim/v2/Users/{}?attributes=userName,emails", user_id))
        .await;
...
async fn test_user_excluded_attributes_parameter() {
    ...
    let response = server
        .get(&format!("/tenant-a/scim/v2/Users/{}?excludedAttributes=emails,phoneNumbers", user_id))
        .await;
...
async fn test_group_attributes_parameter() {
    ...
    let response = server
        .get(&format!("/tenant-a/scim/v2/Groups/{}?attributes=displayName", group_id))
        .await;
...
async fn test_complex_attribute_filtering() {
    ...
    let response = server
        .get(&format!("/tenant-a/scim/v2/Users/{}?attributes=name.givenName", user_id))
        .await;
