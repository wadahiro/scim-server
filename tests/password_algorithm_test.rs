...
async fn test_password_algorithm_integration() {
    ...
    assert!(created_user["password"].is_null(), "Password should not be returned in API response");
    ...
    assert!(retrieved_user["password"].is_null(), "Password should not be returned in GET response");
    ...
    assert!(updated_user["password"].is_null(), "Password should not be returned in PUT response");
    ...
    assert!(patched_user["password"].is_null(), "Password should not be returned in PATCH response");
...
async fn test_password_algorithms_compatibility() {
    ...
    assert!(hash.starts_with("$argon2id$"), "Default should use Argon2id algorithm");
