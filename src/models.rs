...
impl User {
    ...
    pub fn id(&self) -> &Option<String> { &self.base.id }
    pub fn id_mut(&mut self) -> &mut Option<String> { &mut self.base.id }
    pub fn meta(&self) -> &Option<scim_v2::models::scim_schema::Meta> { &self.base.meta }
    pub fn meta_mut(&mut self) -> &mut Option<scim_v2::models::scim_schema::Meta> { &mut self.base.meta }
    pub fn groups_mut(&mut self) -> &mut Option<Vec<scim_v2::models::user::Group>> { &mut self.base.groups }
    pub fn password(&self) -> &Option<String> { &self.base.password }
    pub fn password_mut(&mut self) -> &mut Option<String> { &mut self.base.password }
}
...
impl Clone for User {
    fn clone(&self) -> Self {
        ...
        let cloned_base: ScimUser = serde_json::from_value(json_value).expect("Failed to deserialize ScimUser");
...
impl Group {
    ...
    // Delegate common fields to base for easier access
    pub fn id(&self) -> &String { &self.base.id }
    pub fn id_mut(&mut self) -> &mut String { &mut self.base.id }
    pub fn meta(&self) -> &Option<scim_v2::models::scim_schema::Meta> { &self.base.meta }
    pub fn meta_mut(&mut self) -> &mut Option<scim_v2::models::scim_schema::Meta> { &mut self.base.meta }
    pub fn members(&self) -> &Option<Vec<scim_v2::models::group::Member>> { &self.base.members }
    pub fn members_mut(&mut self) -> &mut Option<Vec<scim_v2::models::group::Member>> { &mut self.base.members }
}
...
impl Clone for Group {
    fn clone(&self) -> Self {
        ...
        let cloned_base: ScimGroup = serde_json::from_value(json_value).expect("Failed to deserialize ScimGroup");
