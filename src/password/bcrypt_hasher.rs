...
impl PasswordHasher for BcryptHasher {
    ...
    fn is_hash(&self, value: &str) -> bool {
        ...
        (value.starts_with("$2") || value.starts_with("$2a$") || value.starts_with("$2b$") || 
         value.starts_with("$2x$") || value.starts_with("$2y$")) &&
        value.len() == 60 && 
...
mod tests {
    ...
    fn test_bcrypt_is_hash() {
        ...
        assert!(!hasher.is_hash("$2b$12$toolongfortesting123456789012345678901234567890")); // too long
    }
